    ...
    <div id="pdfContent">
      <n-card :title="basicInfo.apiName" size="large">
        <n-descriptions label-placement="left">
          ...
          <n-descriptions-item label="频次限制"> {{ basicInfo.apiFrequency }}次/秒 </n-descriptions-item>
      ...
      <n-card size="small" style="height: 200px">
        ...
        <CrudTable :tableData="apiData.portTable.data" :columnData="apiData.portTable.columns" />
      </n-card>
