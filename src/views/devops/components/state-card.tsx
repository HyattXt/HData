  ...
  render() {
    ...
    const progressElements = TaskPieData.table
      ...
      .filter(item => item.ratio !== 0).map((item, index) => {
        ...
        const displayRatio = `${formattedRatio}% | ${item.value}`
        const displayNull = ' ';
        return h('div', { key: index, style: { display: 'flex', alignItems: 'center', margin: '1px 0' } }, [
          ...
          h('p', { style: { width: '15%', marginRight: '5px', textAlign: 'left', flexShrink: 0 } }, { default: () => item.name }), // Left-align 'item.name'
            ...
            <NGi span={2}>
              <Card>
                ...
                <div style="display: flex;padding: 10px; height: 90px">
                  ...
                  <span role="img" style="font-size: 16px; padding-right: 8px; display: inline-flex; align-items: center;">
